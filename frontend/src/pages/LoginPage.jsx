...
export default function LoginPage() {
  ...
  return (
    <AuthLayout title="Welcome back" subtitle="Sign in to keep funding the future." variant="login">
      <button
        type="button"
        onClick={async () => {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
        ...
        <div>
          ...
          <div className="mt-1.5 text-right">
            <Link to="/forgot-password" className="text-xs font-semibold text-primary-700 hover:text-primary-800 transition-colors">
              Forgot password?
            </Link>
          </div>
        </div>
