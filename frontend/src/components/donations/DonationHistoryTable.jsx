  ...
  if (!donations.length) {
    return (
      <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-10 text-center">
        ...
        <p className="mt-2 text-slate-500">{emptyMessage || 'No donations yet.'}</p>
      </div>
    );
  }
              ...
              <td className="px-4 py-3">
                <div className="flex items-center gap-3 min-w-0">
                  {d.campaigns?.image_url ? (
                    ...
                    <div className="w-10 h-10 rounded-lg bg-primary-50 flex items-center justify-center shrink-0 text-lg">💡</div>
                  )}
